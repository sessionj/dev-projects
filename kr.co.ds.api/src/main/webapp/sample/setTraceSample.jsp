...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
        		...
        		<table width="100%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
        			...
        			<c:forEach var="result" items="${resultList}" varStatus="status">
            			<tr>
            				...
            				<td align="left" class="listtd"><c:out value="${result.billno}"/>&nbsp;</td>
            				<td align="left" class="listtd"><c:out value="${result.sendname}"/>&nbsp;</td>
            				<td align="left" class="listtd"><c:out value="${result.arrivalname}"/>&nbsp;</td>
            			</tr>
        			</c:forEach>
        		</table>
        	</div>
     ...
     <form:form modelAttribute="traceEntity" id="listForm" name="listForm" method="post">
        <input type="hidden" name="selectedId" />
        <input type="hidden" name="billno" value="4122201015580" />
