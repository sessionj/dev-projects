...
public class MainActivity_a extends AppCompatActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.textview_v1:
                    Toast.makeText(MainActivity_a.this, Label.RECEIPT_CONSTRUCTOR_FINAL_NAME, Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    public void settingRceptionQuantityModelView(){
        ...
        asyncDialog = new ProgressDialog(MainActivity_a.this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    RequestQueue queue = Volley.newRequestQueue( MainActivity_a.this);
    ...
    private class CheckTypesTask extends AsyncTask<Void, Void, Void> {
        ...
        ProgressDialog asyncDialog = new ProgressDialog(MainActivity_a.this);
