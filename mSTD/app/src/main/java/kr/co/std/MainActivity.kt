...
import kr.co.std.model.MyModel
import kr.co.std.recycler.MyRecyclerAdapter
import kr.co.std.recycler.MyRecyclerviewInterface
...
class MainActivity : AppCompatActivity(), MyRecyclerviewInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 10번 반복한다.
        for (i in 1..10){
            val myModel = MyModel(name = "염대리 $i", profileImage = "https://img1.daumcdn.net/thumb/C100x100.mplusfriend/?fname=http%3A%2F%2Fk.kakaocdn.net%2Fdn%2FIxxPp%2FbtqC9MkM3oH%2FPpvHOkfOiOpKUwvvWcxhJ0%2Fimg_s.jpg")
